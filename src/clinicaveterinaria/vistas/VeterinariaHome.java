...
public class VeterinariaHome extends javax.swing.JFrame {
    ...
    private JInternalFrame formularioCliente;

    public VeterinariaHome() {
        initComponents();
        
        setPreferredSize(new Dimension(830, 550));
        setResizable(true);
        ...
        // Empaqueta la ventana y ajusta los tamaños
        pack(); 
    ...
    private void initComponents() {
        ...
        tablaListaClientes.setAutoCreateColumnsFromModel(false);
            ...
            .addGroup(panelClientesLayout.createSequentialGroup()
                .addGroup(panelClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelClientesLayout.createSequentialGroup()
                        ...
                        .addGap(50, 50, 50)
                        .addComponent(CargarCambiosCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        tablaListaMascotas.setAutoCreateColumnsFromModel(false);
    ...
    private void abrirFormularioCliente(){
        ...
        formulario.setModoNuevo(editandoCliente);
    
        formulario.setVisible(true);

        if (!formulario.isShowing()) {
            tabbedPane.add(formulario);
        }
